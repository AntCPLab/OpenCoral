...
FHEOFFLINE = $(patsubst %.cpp,%.o,$(wildcard FHEOffline/*.cpp FHE/*.cpp)) OT/BitVector.o
...
static-release: static-dir $(patsubst Machines/%.cpp, static/%.x, $(filter-out Machines/malicious-rep-bin-party.cpp,$(wildcard Machines/*-party.cpp)))
...
%.x: Machines/%.o $(VM) $(OT) $(LIBSIMPLEOT)
	$(CXX) -o $@ $(CFLAGS) $^ $(LDLIBS)
...
Player-Online.x: Machines/SPDZ.o
