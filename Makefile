...
coral-party.x: $(OT)
corallowgear-party.x: $(OT)  $(FHEOFFLINE) $(TINIER) Protocols/CowGearOptions.o Protocols/LowGearKeyGen.o
...
mixed-edabit-example.x: $(VM) $(OT) GC/PostSacriBin.o $(GC_SEMI) GC/AtlasSecret.o Machines/Tinier.o
...
mfe = Math/mfe.o Math/mfe64.o

test_mfe: USE_NTL = 1 
test_mfe: test/test_mfe.o Tools/performance.o $(mfe)
	$(CXX) -o $@ $(CFLAGS) $^ $(LDLIBS)

test_mfe64: USE_NTL = 1 
test_mfe64: test/test_mfe64.o Tools/performance.o $(mfe)
	$(CXX) -o $@ $(CFLAGS) $^ $(LDLIBS)
